  ...
  return Container(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        labelText: labelText,
        hintText: hintText,
        prefixIcon: const Icon(Icons.currency_exchange, color: fxPrimaryColor),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: fxPrimaryColor),
        ),
      ...
      validator:
          ...
          (value) {
            ...
            if (double.tryParse(value)! > max) {
              return "Amount is can not be more than $max";
            }
            if (double.tryParse(value)! < min) {
              return "Amount is can not be less than $min";
            }
            return null;
          },
    ),
  ...
  return Container(
    ...
    child: TextFormField(
      ...
      onTap: () async {
        ...
        if (pickedDate != null) {
          controller.text = "${pickedDate.toLocal()}".split(
            ' ',
          )[0]; // YYYY-MM-DD
        }
      },
